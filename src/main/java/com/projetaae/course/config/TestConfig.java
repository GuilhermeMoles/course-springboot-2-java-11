package com.projetaae.course.config;
...
import com.projetaae.course.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        /* Cria o relacionamento entre produtos e categorias */
        p1.getCategories().add(cat2); //Trabalhando com OO para criar os relacionamentos.
        ...
        /* Salva os relacionamentos no banco */
        productRepository.saveAll(Arrays.asList(p1,p2,p3,p4,p5));
